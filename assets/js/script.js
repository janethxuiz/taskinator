...
var taskInProressEl = document.querySelector("tasks-in-progress");
...
var createTaskActions = function(taskId) {
    ...
    for (var i = 0; i < statusChoices.length; i++) {
        ...
        statusOptionEl.appendChild(statusOptionEl);
    }
...
var taskStatusChangeHandler = function(event) {
    ...
    if (stausValue === "to do") {
        ...
        taskInProressEl.appendChild(taskSelected);
...
var editTask = function(taskId) {
    ...
    var taskSelected = document.querySelector(".task-team[data-task-id'" + taskId + "']");
